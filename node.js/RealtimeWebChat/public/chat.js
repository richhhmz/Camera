window.onload = function() {
    ...
    sendButton.onclick = sendMessage = function() {
        if(name.value == "") {
            ...
            //Base64 test
            //encoded string says "SGVsbG8gV29ybGQh", verified in 
            //https://scotch.io/quick-tips/how-to-encode-and-decode-strings-with-base64-in-javascript
            var hw = "Hello World!";
            alert(Base64.encode(hw)+"\n"+Base64.decode(Base64.encode(hw))); 
            
            //image.src = "IMG1437080850645.jpg"; //managed to display a non-encoded snapshot.
            
            //First picture test
            toggle = !toggle;
            
            //The .jpgs need to be saved in the /public folder, along with this file chat.js.
            if (toggle)
                image.src = "dots.jpg";
            else
                image.src = "squig.jpg";
